...
/** Application cache in front of the repository. The key decides who can reach a cached entry. */
@Service
public class PreviewService {
    ...
    public PreviewService(DocumentStore store) {
        this.store = store;
    }

    public DocumentStore.Document preview(String id, String tenant) {
        // Candidate mode keys by document only; the guided repair adds the trusted tenant.
