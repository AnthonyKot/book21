...
@SpringBootTest(webEnvironment=SpringBootTest.WebEnvironment.RANDOM_PORT,properties={"lab.partition=${test.partition:true}"})
class ReviewRepairTest extends ReviewHttp {
