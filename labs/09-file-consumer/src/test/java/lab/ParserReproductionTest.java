...
@SpringBootTest(webEnvironment=SpringBootTest.WebEnvironment.RANDOM_PORT,properties={"lab.fixture-port=0","lab.hardened=${test.hardened:false}"})
class ParserReproductionTest extends UploadHttp {
    private static final boolean HARDENED=false;
