...
@SpringBootTest(webEnvironment=SpringBootTest.WebEnvironment.RANDOM_PORT,
    properties="lab.bind-title=${test.bind-title:true}")
class QueryRepairTest extends QueryHttp {
    ...
    @Test void apostrophe() throws Exception { ids(search("O'Brien"),"C-1002"); }
