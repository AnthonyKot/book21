...
const essays = [
  ...
  {slug:'03-draw-the-boundary',part:'Change the engineering question',title:'Draw the boundary before choosing the control',payoff:'For each decision, name the facts it reads and who can write them, then judge whether proposed controls sit at those crossings.'},
  ...
  {slug:'08-fetch-authority',part:'Find and repair application failures',title:'A fetch endpoint borrows the server’s network access',payoff:'Trace an approved URL through a forbidden redirect, then design the destination policy for a second approved origin and prove the forbidden one stays unreachable.'},
  {slug:'09-file-consumer',part:'Find and repair application failures',title:'A file becomes a program in the component that opens it',payoff:'Trace stored XML into a parser’s file and network access, repair the interpretation boundary, then review a release whose new consumers you must assess yourself.'},
  {slug:'10-valid-requests',part:'Find and repair application failures',title:'Two valid requests can violate one business rule',payoff:'Control a credit race, distinguish duplicate from partial effects, and choose tests for a second caller.'},
  {slug:'11-security-property',part:'Find and repair application failures',title:'Review the security property, including in generated code',payoff:'Trace each path that can return protected data, challenge a generated release with your own tests, and defend what the evidence permits you to approve.'},
...
<p class="status">Fourteen essays available. New chapters will extend the path into application security, secure delivery and AI systems.</p>
...
const practice=[
  ...
  {n:11,essay:'11-security-property',sheet:'11-review-worksheet',review:'11-review-guide',name:'Security review'},
