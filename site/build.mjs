...
const essays = [
  ...
  {slug:'11-security-property',part:'Find and repair application failures',title:'Review the security property, including in generated code',payoff:'Find the cache-hit path a tenant-check patch misses, then review a generated release against its property, path by path, before it merges.'},
