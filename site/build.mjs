...
const essays = [
  ...
  {slug:'03-draw-the-boundary',title:'Draw the boundary before choosing the control',payoff:'Trace who is asking through every component, find where trust changes, and pick controls that fit those crossings.'},
];
...
<p class="status">Three essays available. New chapters will extend the path into application security, secure delivery and AI systems.</p>
