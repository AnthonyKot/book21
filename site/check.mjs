...
if(pages.length!==42)throw Error(`Expected forty-two pages, got ${pages.length}`);
console.log('Checked forty-two pages, headings, local destinations and private-path exclusions.');
