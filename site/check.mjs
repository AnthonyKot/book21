...
if(pages.length!==48)throw Error(`Expected forty-eight pages, got ${pages.length}`);
console.log('Checked forty-eight pages, headings, local destinations and private-path exclusions.');
