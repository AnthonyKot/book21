...
if(pages.length!==33)throw Error(`Expected thirty-three pages, got ${pages.length}`);
console.log('Checked thirty-three pages, headings, local destinations and private-path exclusions.');
