...
if(pages.length!==12)throw Error(`Expected twelve pages, got ${pages.length}`);
console.log('Checked twelve pages, headings, local destinations and private-path exclusions.');
