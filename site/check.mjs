...
if(pages.length!==15)throw Error(`Expected fifteen pages, got ${pages.length}`);
console.log('Checked fifteen pages, headings, local destinations and private-path exclusions.');
