...
if(pages.length!==45)throw Error(`Expected forty-five pages, got ${pages.length}`);
console.log('Checked forty-five pages, headings, local destinations and private-path exclusions.');
