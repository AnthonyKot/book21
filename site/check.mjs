...
if(pages.length!==30)throw Error(`Expected thirty pages, got ${pages.length}`);
console.log('Checked thirty pages, headings, local destinations and private-path exclusions.');
