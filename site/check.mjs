...
if(pages.length!==6)throw Error(`Expected six pages, got ${pages.length}`);
console.log('Checked six pages, headings, local destinations and private-path exclusions.');
